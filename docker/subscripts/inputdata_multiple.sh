...
ncks --fl_fmt=64bit -F -v u850,u700,u500,u200,v850,v700,v500,v200,h900,h850,h800,h750,h700,h650,h600,h550,h500,h450,h400,h350,h300,h200,TMP500_300,q1000,q925,q850,q800,q750,q700,q650,q600,t1000,t925,t800,t750,t700,t650,t600,PRMSL,omg500 ${data}/${data_file1} ${netcdf_combined_file} || exit 1
ncks --fl_fmt=64bit -F -A -v UGRD10m,VGRD10m,TMPsfc ${data}/${data_file2} ${netcdf_combined_file} || exit 1
