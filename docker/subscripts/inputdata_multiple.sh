...
export netcdf_temp_file_1=${wdir}/atmos_temp.${pdy}${hh}.nc
export netcdf_temp_file_2=${wdir}/nggps2d_temp.${pdy}${hh}.nc
export netcdf_combined_file=${wdir}/combined.${pdy}${hh}.nc   # leave combined file named as is
...
export netcdffile=${wdir}/combined.${pdy}${hh}.nc
