...
export curymdh=2025080806 # USER - date from model initilization date
...
export home=/scratch4/AOML/aoml-hafs1/Lew.Gramer/ocean/GenesisTracker
export workroot=/scratch4/AOML/aoml-hafs1/role.aoml-hafs1/scrub/HAFSV2.1M_2025_RT/GenesisTracker
...
#data_dir=/scratch4/AOML/aoml-hafs1/role.aoml-hafs1/scrub/HAFSV2.1M_2025_RT/
data_dir=/scratch4/AOML/aoml-hafs1/role.aoml-hafs1/scrub/HAFSV2.1M_2025_RT/2025080800/00L/forecast.2014991
...
export STRUCTFLAG=y
export IKEFLAG=y
export genflag=y #USER (LJG) - keep?
export sstflag=y #USER (LJG) - keep?
export shear_calc_flag=y #USER (LJG) - keep?
...
#-----------------------------------------------------------------------
need_to_combine=n
data_file1=atmf000.nc # USER (LJG - was blank)
#data_file2=
