#!/bin/bash -l
#SBATCH  -o output/rmecix_file.out
#SBATCH  -J tracker
...
#------------------------------------------------------
export PS4=' + TRACKER SET UP line $LINENO: '
...
export home=/mnt/lfs5/HFIP/hfip-gfdl/Caitlyn.Mcallister/fix_grib_runs
