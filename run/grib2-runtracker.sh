#!/bin/bash -l
#SBATCH  -o output/trygrib2_pt3.out
#SBATCH  -J tracker
...
# changing for grib2, going to match this to what tim has in script on wcoss2
...
export CYL=${cyc} # CAITLYN - this is repetative and is being removed, MIGHT ALSO NEED TO BE EDITED IN NETCDF RUNSCRIPT
		  # caitlyn, this is used differently for grib on wcoss2
...
g2_jpdtn=0
inp_data_type=grib
export gribver=2 # not sure why this is =1 and comment in netcdf runscript is =2
g2_mlsp_parm_id=192
g1_mslp_parm_id=130
