#!/bin/bash --login
# SECTION 1; Add batch commdands if needed
# if running in container leave these lines as they are
# NOTE shell type is defaulted to bash, change if necessary
...
# -------------------------------------------------------------------------------------------------
# SECTION 2; ALL CODE IN THE SECTION BELOW WILL NEED TO BE MODIFIED;
...
# Name of rdhpc system (gaea, analysis, wcoss2, etc.), container, or blank if on personal system
export which_system=''
...
# set wdir path
export wdir=${workdir}/${today_stamp}
