...
export ncdf_mslpname='slp'              # mean sea level pressure (mb)
...
export ncdf_z200name='h200'              # 200mb geopotential height (m)
...
export ncdf_tmean_300_500_name='tm'    # averaged 300mb-500mb temperature (K)
...
export ncdf_lmaskname='SLMSKsfc'             # land mask variable name (N/A)
