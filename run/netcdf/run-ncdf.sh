...
# The below variable (y/n) is dependent on developer’s preference;
# If yes, a script will be ran that clears up space in work dir after tracker is ran to completion
# This does not effect any files that the tracker creates
export usecleanup=''
